...
import 'package:salama/Services/init.dart';

Backgroundwork workClass = Backgroundwork();
...
class _ActiveGroupState extends State<ActiveGroup> {
  ...
  void activateTimer() {
    Timer.periodic(Duration(minutes: 2), (timer) async {
      ...
      var a = 0.5 -
          ...
          cos(userLatitude * p) *
              cos(groupLatitude * p) *
              (1 - cos((groupLongitude - userLongitude) * p)) /
              2;
  ...
  void initState() {
    ...
    Workmanager().initialize(
      Backgroundwork.callbackDispatcher,
      isInDebugMode: true,
    );
                  ...
                  ? Column(
                      ...
                      children: <Widget>[
                        ...
                        TextButton(
                          ...
                          child: Padding(
                            padding:
                                const EdgeInsets.fromLTRB(60.0, 30, 60, 60),
                            child: Container(
                              decoration: BoxDecoration(
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              TextButton(
                                ...
                                child: Padding(
                                  padding:
                                      const EdgeInsets.fromLTRB(60.0, 0, 60, 0),
                                  child: Container(
                                    decoration: BoxDecoration(
                                        color: Colors.amberAccent,
                                        borderRadius: new BorderRadius.all(
